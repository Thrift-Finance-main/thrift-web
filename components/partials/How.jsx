              ...
              <div className="mb-8 md:mb-0">
                { how_json.list.items.map((item, index) =>
                {
                  return (
                    ...
                    >
                      <div className={ " " + (tab === index + 1 ? 'text-gray-900' : (darkM ? 'text-gray-200' : 'text-gray-900')) }>
                        <div className="font-bold leading-snug text-left tracking-tight mb-1">{ item.heading }</div>
