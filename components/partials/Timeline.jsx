      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        <div className="py-12 md:py-20 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4 !font-normal text-2xl font-header ">{timeline_json.heading}</h2>
          ...
          <div style={{
            ...
            <div className="flex items-start">
              ...
              <div className="relative mr-4 sm:mr-12 lg:mr-32">
                ...
                {
                  years.map(item => (
                    <button key={item} className="relative flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left" onClick={() => setYear(item)}>
              ...
              {/* 2020's articles */ }
              {
                timeline_json.group.map((group_item, ind) => (
                  <div key={ind} className={`grow ${year !== group_item.year && 'hidden'}`}>
