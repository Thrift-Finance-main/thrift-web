                  ...
                  <div key={index}>
                    <div className="text-center text-gray-500 dark:text-gray-400">
                      ...
                      <p className="mb-1 text-2xl font-bold tracking-tight">
                        <a className="dark-here text-gray-900" href="#">{item.name}</a>
                      </p>
                      <p>{item.title}</p>
                      <ul className="flex justify-center mt-4 space-x-4">
                        <li>
                          <a href="#" className="text-[#ea4c89] dark:hover:text-gray-400 dark:text-gray-500">
                        ...
                        <li>
                          <a href="#" className="text-[#00acee] dark:hover:text-gray-400 dark:text-gray-500">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" ariaHidden="true">
                              <path
