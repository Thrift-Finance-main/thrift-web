          ...
          <div className="max-w-sm mx-auto md:max-w-none">
            <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  <a to="/blog-post" className="block mb-6">
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a to="/blog-post" className="hover:underline">“How HubSpot saved 25% on developing costs by switching to Simple.”</a>
                  </h3>
                </header>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a to="/blog-post" className="hover:underline">“How Facebook brought 13% cost savings to their bottom line with Simple’s products.”</a>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex shrink-0 mr-3">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a to="/blog-post" className="hover:underline">“How Tinder grew 115% and saved 120 Hours each week by outsourcing to Simple.”</a>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex shrink-0 mr-3">
