...
import UserImage01 from '../images/testimonial-01.jpg';
import UserImage02 from '../images/testimonial-02.jpg';
import UserImage03 from '../images/testimonial-03.jpg';
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="relative mt-20" data-aos="zoom-y-out">
              ...
              {/* Testimonials */}
              <div className="relative flex items-start border-2 border-gray-200 rounded bg-white z-10" ref={testimonials}>
                ...
                {items.map((item, index) => (
                  ...
                  >
                    <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                      ...
                      <img className="relative rounded-full" src={item.img} width="96" height="96" alt={item.alt} />
                    </div>
